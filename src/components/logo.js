...
const Logo = ({inversed, height}) => {
  ...
  return (
    <svg style={backgroundStyle} version="1.1" xmlns="http://www.w3.org/2000/svg"
        x="0px" y="0px" width="41px" height="42px" viewBox="-0.501 -0.75 41 42" enable-background="new -0.501 -0.75 41 42">
